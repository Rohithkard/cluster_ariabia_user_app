...
class StudentViewById {
  bool? success;
  String? message;
  String? instance;
  Data? data;

  StudentViewById({this.success, this.message, this.instance, this.data});

  StudentViewById.fromJson(Map<String, dynamic> json) {
